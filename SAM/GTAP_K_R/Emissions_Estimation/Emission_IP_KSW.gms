...
*         Emit_Prcs("2009","CO2","0157") = 0;
         Emit_Prcs(t,"CO2","0157")$(not told(t)) = Emit_Prcs(t,"CO2","0157") + (Data_Lst(t) * Data_Lst_CCf) * (IOT_B0(t,"0033","0188")/(IOT_B0(t,"0033","0157")+IOT_B0(t,"0033","0277")))   ;);
if(Prcs_ratio,
...
if(not Prcs_ratio,
         Emit_Prcs(t,"N2O","0123")$(not told(t)) = Emit_GIR(t,"p_che_n2o") * XP_B0(t,"0152") / ( XP_B0(t,"0123") + XP_B0(t,"0115") ) ; );
...
Emit_Prcs(yeark,"CH4","0111") = Data_Et(yeark) * Data_Et_CCf * GWP_CH4 + Data_St(yeark) * Data_St_CCf * GWP_CH4;
Emit_Prcs(yeark,"CH4","0112") = Data_Et(yeark) * Data_Et_CCf * GWP_CH4 + Data_St(yeark) * Data_St_CCf * GWP_CH4;
...
if(not Prcs_ratio,
         ...
         xp_b0(t,"0001") / ( xp_b0(t,"0001") + xp_b0(t,"0002") + xp_b0(t,"0002") + xp_b0(t,"0005") + xp_b0(t,"0003") ) ;);
if(Prcs_ratio,
         loop(yeark$t(yeark), Emit_Prcs(yeark,"CH4","0001") = Emit_Prcs(yeark,"CH4","0001") + Emit_GIR(yeark,"a_res_ch4") *
         xp_b0(yeark,"0001") / ( xp_b0(yeark,"0001") + xp_b0(yeark,"0002") + xp_b0(yeark,"0002") + xp_b0(yeark,"0005") + xp_b0(yeark,"0003") ) ;);
         loop(yeark$(not t(yeark) and (xp_b0(yeark+1,"0001"))), Emit_Prcs(yeark,"CH4","0001") = Emit_Prcs(yeark,"CH4","0001") + Emit_GIR(yeark,"a_res_ch4") *
         xp_b0(yeark+1,"0001") / ( xp_b0(yeark+1,"0001") + xp_b0(yeark+1,"0002") + xp_b0(yeark+1,"0002") + xp_b0(yeark+1,"0005") + xp_b0(yeark+1,"0003") ) ;);
         ...
         xp_b0("2003","0001") / ( xp_b0("2003","0001") + xp_b0("2003","0002") + xp_b0("2003","0002") + xp_b0("2003","0005") + xp_b0("2003","0003") ) ;););
...
if(not Prcs_ratio,
         ...
         xp_b0(t,"0002") / ( xp_b0(t,"0001") + xp_b0(t,"0002") + xp_b0(t,"0002") + xp_b0(t,"0005") + xp_b0(t,"0003") ) ;);
if(Prcs_ratio,
         loop(yeark$t(yeark), Emit_Prcs(yeark,"CH4","0002") = Emit_GIR(yeark,"a_res_ch4") *
         xp_b0(yeark,"0002") / ( xp_b0(yeark,"0001") + xp_b0(yeark,"0002") + xp_b0(yeark,"0002") + xp_b0(yeark,"0005") + xp_b0(yeark,"0003") ) ;);
         loop(yeark$(not t(yeark) and (xp_b0(yeark+1,"0001"))), Emit_Prcs(yeark,"CH4","0002") = Emit_GIR(yeark,"a_res_ch4") *
         xp_b0(yeark+1,"0002") / ( xp_b0(yeark+1,"0001") + xp_b0(yeark+1,"0002") + xp_b0(yeark+1,"0002") + xp_b0(yeark+1,"0005") + xp_b0(yeark+1,"0003") ) ;);
         loop(yeark$(not t(yeark) and not xp_b0(yeark+1,"0001")), Emit_Prcs(yeark,"CH4","0002") = Emit_GIR(yeark,"a_res_ch4") *
         xp_b0("2003","0002") / ( xp_b0("2003","0001") + xp_b0("2003","0002") + xp_b0("2003","0002") + xp_b0("2003","0005") + xp_b0("2003","0003") ) ;););
** 0003 Wheat
...
if(Prcs_ratio,
         ...
         xp_b0(yeark,"0005") / ( xp_b0(yeark,"0001") + xp_b0(yeark,"0002") + xp_b0(yeark,"0002") + xp_b0(yeark,"0005") + xp_b0(yeark,"0003") ) ;);
         loop(yeark$(not t(yeark) and (xp_b0(yeark+1,"0001"))), Emit_Prcs(yeark,"CH4","0005") = Emit_GIR(yeark,"a_res_ch4") *
         xp_b0(yeark+1,"0005") / ( xp_b0(yeark+1,"0001") + xp_b0(yeark+1,"0002") + xp_b0(yeark+1,"0002") + xp_b0(yeark+1,"0005") + xp_b0(yeark+1,"0003") ) ;);
         loop(yeark$(not t(yeark) and not xp_b0(yeark+1,"0001")), Emit_Prcs(yeark,"CH4","0005") = Emit_GIR(yeark,"a_res_ch4") *
         xp_b0("2003","0005") / ( xp_b0("2003","0001") + xp_b0("2003","0002") + xp_b0("2003","0002") + xp_b0("2003","0005") + xp_b0("2003","0003") ) ;););
...
if(not Prcs_ratio,
         ...
         xp_b0(t,"0003") / ( xp_b0(t,"0001") + xp_b0(t,"0002") + xp_b0(t,"0002") + xp_b0(t,"0005") + xp_b0(t,"0003") ) ;);
if(Prcs_ratio,
         loop(yeark$t(yeark), Emit_Prcs(yeark,"CH4","0003") = Emit_GIR(yeark,"a_res_ch4") *
         xp_b0(yeark,"0003") / ( xp_b0(yeark,"0001") + xp_b0(yeark,"0002") + xp_b0(yeark,"0002") + xp_b0(yeark,"0005") + xp_b0(yeark,"0003") ) ;);
         loop(yeark$(not t(yeark) and (xp_b0(yeark+1,"0001"))), Emit_Prcs(yeark,"CH4","0003") = Emit_GIR(yeark,"a_res_ch4") *
         xp_b0(yeark+1,"0003") / ( xp_b0(yeark+1,"0001") + xp_b0(yeark+1,"0002") + xp_b0(yeark+1,"0002") + xp_b0(yeark+1,"0005") + xp_b0(yeark+1,"0003") ) ;);
         loop(yeark$(not t(yeark) and not xp_b0(yeark+1,"0001")), Emit_Prcs(yeark,"CH4","0003") = Emit_GIR(yeark,"a_res_ch4") *
         xp_b0("2003","0003") / ( xp_b0("2003","0001") + xp_b0("2003","0002") + xp_b0("2003","0002") + xp_b0("2003","0005") + xp_b0("2003","0003") ) ;););
