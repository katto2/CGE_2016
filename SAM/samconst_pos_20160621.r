...
source("IO/agg_20160621.r")
source("GHG/agg_ghg_20160621.r")
source("sam_2010.r")
secter_BR=read.csv(file="sector_BR.csv",header=T,as.is=T)
...
GHG_model=read.csv(file="GHG_model_p_20160621.csv",header=T,as.is=T)
...
GHG_BR=read.csv(file="GHG_BR_p_20160621.csv",header=T, as.is=T)
...
write.csv(SAM_model_ng_pos,file="b_sam_model_ng_pos.csv")
write.csv(SAM_model_k5,file="b_sam_model_g_pos.csv")

source("setwriting_standard_2016.r")
source("parameter.r")