...
sam_model=read.csv(file="b_sam_agri_model_ng_pos.csv",header=T,as.is=T)
ghg=read.csv(file="GHG_agri_model_p_20160621.csv",header=T,as.is=T)
...
Link="Link"
#mode=2
if(Link=="Link"){if (Tmax==0) {filename="set_agri_static_link_2016_alt.txt"} else  {filename="set_agri_recursive_link_2016_alt.txt"}} else {if (Tmax==0) {filename="set_agri_static_nonlink_2016_alt.txt"} else  {filename="set_agri_recursive_nonlink_2016_alt.txt"}}
