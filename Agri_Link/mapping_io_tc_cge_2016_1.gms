* Mapping io_tc_cge with 53 sectors
set
io /1*391/
...
OINPUT, OSERV, KCOST, LCOST, SURplus, TW/
...
$ondelim
$include "..\SAM\Agri\consistency\iocost_r_Agri_0121.csv"
$offdelim;

Table Agricost(tc,j)
$ondelim
$include "..\SAM\Agri\consistency\cost_Agri_0121.csv"
$offdelim;
